...
public class AppointmentDao {
	...
	public List<Appointment>getAllAppointmentByLoginUser(int userId){
		...
		try {
			String sql="select * from appointment where user_id=? order by id asc";
	...
	public boolean updateComment(int id,int doct_id,String comm) {
		boolean f=false;
		try {
	...
	public int countAppointmentByDoctor(int id) {
		int count=0;
		try {
		    String sql="select * from appointment where doctor_id=?";
		    PreparedStatement ps=conn.prepareStatement(sql);
